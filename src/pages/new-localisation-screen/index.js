            ...
            <div className="text-white rounded-3xl z-0">
                ...
                <div className=" mt-2">
                    <div className="flex flex-col items-center w-screen">
                        <h1 id="font" className="text-2xl md:text-5xl mb-4 md:mb-10 text-center">Gérer les villes</h1>
                        <div className="flex flex-row items-center gap-2 bg-slate-200 rounded-3xl w-1/3">
                            <button className="pl-4"><UilSearch size="50" color="#36494E" /></button>
                            <input id="font" className="bg-slate-200 w-full h-10 rounded-3xl text-gray-600 text-lg  pl-4" placeholder="saisir la ville" type="text"
