...
const WindHumidityRain = ({windUnit, wind, humidityUnit, humidity, rain, rainUnit}) =>{
    return(
        <div className="flex gap-4 border-gray-200 border-2 rounded-3xl mb-10 p-3 justify-center h-20 text-sm lg:w-auto lg:pl-10 lg:pr-10 md:w-auto md:pl-10 md:pr-10 ">
                        <div className="flex flex-col items-center justify-center">
                            <div className='text-2xl'><WiStrongWind/></div>
                        ...
                        <div className="flex flex-col items-center border-x-2 pl-4 pr-4 justify-center">
                            <div className='text-2xl'><WiHumidity/></div>
                            <span>{`${humidity} ${humidityUnit}`}</span>
                            <span className="font-thin">Humidity</span>
                        </div>
                        <div className="flex flex-col items-center justify-center">
                            <div className='text-2xl'><FaCloudRain/></div>
