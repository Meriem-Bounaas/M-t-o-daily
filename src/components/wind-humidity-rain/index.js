...
const WindHumidityRain = ({windUnit, wind, humidityUnit, humidity, rain, rainUnit}) =>{
    return(
        <div className="flex gap-4 text-white border-gray-200 border-2 rounded-3xl mb-10 p-3 justify-center h-20 text-sm lg:w-auto lg:pl-10 lg:pr-10 md:w-auto md:pl-10 md:pr-10 ">
